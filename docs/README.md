...
| [supabase.md](supabase.md)               | Supabase Postgres: Connect modes, pgvector, Prisma + `supabase/migrations`, GitHub integration |
...
- Interactive OpenAPI: `GET /docs` when the server is running
